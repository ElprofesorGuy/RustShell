/// Module parser : construit une représentation structurée à partir des tokens.
///
/// Produit un pipeline de commandes (Vec<Command>) avec leurs arguments,
/// redirections, et flags. Gère les séquences (;), les opérateurs logiques
/// (&& et ||), et les arrière-plans (&).
